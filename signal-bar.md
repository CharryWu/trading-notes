...
要考虑tradeoff：在趋势已经确立的前提下，在趋势发展了一段时间后再入场，胜率更高，但是距离最佳止损点（趋势开始位置）更远；在趋势未明确情况下入场，胜率更低，但距离最佳止损点更近。

## 顺趋势强信号k线的例子（不一定灵）需要依据上下文决定，需要多个信号验证

![sell-signal-1](./img/sell-strong-tails.png)
![sell-signal-2](./img/sell-follow-through.png)
![strong-buy](./img/strong-buy-follow-through.png)

## 顺趋势弱信号k线例子（有可能灵验）需要依据上下文决定，需要多个信号验证

![weak-signal-bar](./img/weak-signal-bar.png)
...
![weak-1](./img/weak-bull-reversal-bar.png)
![weak-2](./img/weak-bull-reversal-bar-2.png)
